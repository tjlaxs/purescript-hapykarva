...
(function(exports) {
  ...
  var UpdatedData = (function () {
      ...
      UpdatedData.create = function (value0) {
          return new UpdatedData(value0);
      };
      return UpdatedData;
  })();
  var hapykarva = (function () {
      var render = function (state) {
          ...
          return elem("svg")([ attr("viewBox")("0 0 " + (Data_Show.show(Data_Show.showInt)(100) + (" " + Data_Show.show(Data_Show.showInt)(100)))), attr("class")("Icon Icon-foo") ])([ elem("path")([ attr("d")("M" + (Data_Show.show(Data_Show.showInt)(0 * spc | 0) + ("," + (Data_Show.show(Data_Show.showNumber)(interpolate(10.0)) + ("L" + (Data_Show.show(Data_Show.showInt)(1 * spc | 0) + ("," + (Data_Show.show(Data_Show.showNumber)(interpolate(22.0)) + ("L" + (Data_Show.show(Data_Show.showInt)(2 * spc | 0) + ("," + (Data_Show.show(Data_Show.showNumber)(interpolate(-11.0)) + ("L" + (Data_Show.show(Data_Show.showInt)(3 * spc | 0) + ("," + Data_Show.show(Data_Show.showNumber)(interpolate(30.0))))))))))))))))), attr("fill")("none"), attr("stroke")("grey") ])([  ]) ]);
      };
      var initialState = {
      ...
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v1))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new UpdatedData(v1.data)))(function () {
  ...
  exports["hapykarva"] = hapykarva;
})(PS["Svg.Hapykarva"] = PS["Svg.Hapykarva"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var Prelude = PS["Prelude"];
  var Svg_Hapykarva = PS["Svg.Hapykarva"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Svg_Hapykarva.hapykarva)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
