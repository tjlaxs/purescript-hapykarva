...
(function(exports) {
  ...
  var hapykarva = (function () {
      var render = function (state) {
          var xSpacing = 100 / (Data_Array.length(state.data) - 1 | 0) | 0;
          var svgElem = Halogen_HTML_Elements.elementNS("http://www.w3.org/2000/svg");
          var svag = function (name) {
              return svgElem(name);
          };
          return svag("svg")([ Halogen_HTML_Properties.attr("viewBox")("0 0 " + (Data_Show.show(Data_Show.showInt)(100) + (" " + Data_Show.show(Data_Show.showInt)(100)))), Halogen_HTML_Properties.attr("class")("Icon Icon-foo") ])([ svag("path")([ Halogen_HTML_Properties.attr("d")("M10 10 H 90 V 90 H 10 L 10 10") ])([  ]) ]);
      };
      var initialState = {
